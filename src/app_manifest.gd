...
var _metadata := {
    ...
    app_name = "Scaffolder Bootstrap",
    app_id = "games.snoringcat.scaffolder_bootstrap",
    app_version = "0.0.1",
    score_version = "0.0.1",
    ...
    github_url = "https://github.com/SnoringCatGames/scaffolder-bootstrap",
...
var _images_overrides := {
    app_logo = preload("res://addons/scaffolder/assets/images/logos/scaffolder_logo.png"),
    app_logo_scale = 1.0,
...
var _colors_manifest := {
    ...
    click = ScaffolderColors.static_opacify(
            Color.white, ScaffolderColors.ALPHA_SLIGHTLY_FAINT),
    ruler = Color.white,
}
...
""",
    ...
    main_menu_image_scene = \
            preload("res://addons/scaffolder/src/gui/placeholder_loading_image.tscn"),
